...
const PrivacyPage = () => (
  <Page>
    <Hero title="Dataskydd" />

    <Content>
      <p>
        Pepp lägger stor vikt vid att värna om våra medlemmars integritet och är
        därför noggranna med att skydda dina personuppgifter. För oss är det
        viktigt att du ska kunna känna dig trygg med hur vi hanterar dina
      ...
      <p>
        ...
        medarbetare, och lämpliga tekniska säkerhetsåtgärder är vidtagna för att
        säkerställa att personuppgifterna är trygga. Pepp använder
      ...
      <p>
        Om du inte har visat intresse för informationen vi skickat till dig inom
        18 månader kommer alla dina personuppgifter att raderas ur våra system.
      </p>
      <p>

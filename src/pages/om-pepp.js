...
const About = () => (
  <Page>
    ...
    <Narrow>
      ...
      <P>
        Edits väg in till KTH var aldrig självklar och gick slumpmässigt via ett
        tekniskt basår där hon för första gången fick upp ögonen för hur kul
        skolan kunde vara utöver det sociala. Edit visste egentligen väldigt
        lite om vad det innebar att vara ingenjör och att plugga hade tidigare
        inte riktigt känts som hennes grej, så att hon hamnade på KTH anser hon
        själv vara tack vare slumpen.
      </P>
      <P>
